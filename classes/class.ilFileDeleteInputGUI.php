...
class ilFileDeleteInputGUI extends ilFormPropertyGUI {
	...
	public function render($a_mode = '') {
		/** @var ilCtrl $ilCtrl */
		global $ilCtrl;
		$delete_tpl = new ilTemplate('Customizing/global/plugins/Libraries/InputGUIs/templates/tpl.delete_files.html', TRUE, TRUE);
	...
	function insert(&$a_tpl)
	{
		...
		$tpl->addCss('Customizing/global/plugins/Libraries/InputGUIs/templates/delete_files_input.css');
		$tpl->addJavaScript('Customizing/global/plugins/Libraries/InputGUIs/js/delete_files_input.js');
		$html = $this->render();
