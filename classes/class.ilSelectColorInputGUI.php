...
require_once('Customizing/global/plugins/Libraries/InputGUIs/classes/class.ilSelectColorInputOption.php');
...
class ilSelectColorInputGUI extends ilFormPropertyGUI {
	...
	function render($a_mode = '') {
		$color_tpl = new ilTemplate('Customizing/global/plugins/Libraries/InputGUIs/templates/tpl.select_color_input.html', TRUE, TRUE);
	...
	function insert(&$a_tpl) {
		...
		$tpl->addCss('Customizing/global/plugins/Libraries/InputGUIs/templates/custom_color_picker.css');
		$tpl->addCss('Customizing/global/plugins/Libraries/InputGUIs/templates/select_color_input.css');
		if (!$this->getDisabled()) {
			$tpl->addJavaScript('Customizing/global/plugins/Libraries/InputGUIs/js/custom_color_picker.js');
		}
